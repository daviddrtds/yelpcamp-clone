...
const campRoutes = require("./routes/routes");
  ...
  helmet.contentSecurityPolicy({
    directives: {
      ...
      imgSrc: [
        ...
        "blob:",
        "data:",
        "https://res.cloudinary.com/dywxkwcei/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT!
        "https://images.unsplash.com/",
        "https://tinyurl.com/bdfzx5bh",
      ],
...
app.use((err, req, res, next) => {
  ...
  if (!err.message) err.message = "Oh NO! Something Happened!";
